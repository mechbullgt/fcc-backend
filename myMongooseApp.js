  ...
  ***********************************************/
  ...
  //   name:"Tony",
  //   age:"19",
  //   favoriteFoods:["wraps","burger"]
  // });

  // youngPerson.save((err, person)=>{
  //   if(err) return console.error("Error creating document",err);
  //   console.log("Success "+person.name+" got added to the database.");
  // });
  ...
  function handlerRemoveManyPeople(err, data){
    if(err){
      console.log("Error while removing many people: ",err);
      throw err;
    }
    console.log("Success removing many people:",data.deletedCount);
  }

//  removeManyPeople(handlerRemoveManyPeople);
